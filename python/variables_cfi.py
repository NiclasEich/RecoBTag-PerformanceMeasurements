...
variableList = [
    ...
    cms.PSet(
        ...
        description=cms.string(
            "the true number of pileup interactions that have been added to the event"
        ),
        requires=cms.vstring(),
    ...
    cms.PSet(
        ...
        mconly=cms.bool(False),
        description=cms.string(
            "the number of tracks originating from each interaction, where track pT > low_cu"
        ),
        requires=cms.vstring(),
        runOptions=cms.vstring("fillPU", "runEventInfo"),
    ),
    ...
    cms.PSet(
        ...
        mconly=cms.bool(False),
        description=cms.string(
            "vertex mass times the fraction of the vertex energy with respect to the jet energy"
        ),
        requires=cms.vstring("nJet"),
        runOptions=cms.vstring("runCTagVariables"),
    ),
