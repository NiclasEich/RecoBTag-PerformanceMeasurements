...
HLTTwoFileBTagAnalyzer = cms.EDAnalyzer("HLTTwoFileBTagAnalyzer",
    variableSet,
    groupSet,
    trackClassifier,
    ...
    reco_muonCollectionName = cms.InputTag("slimmedMuons"),
    reco_electronCollectionName = cms.InputTag("slimmedElectrons"),
    # reco_electronID = cms.InputTag("slimmedElectrons:cutBasedElectronID-Fall17-94X-V1-tight"),
    reco_electronID = cms.string("cutBasedElectronID-Fall17-94X-V1-tight"),
    reco_Jets = cms.InputTag("slimmedJets"),
    reco_met = cms.InputTag("slimmedMETs"),
    reco_photons = cms.InputTag("slimmedMETs"),
    reco_vertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    reco_btagAlgosDeepCSV = cms.vstring(["pfDeepCSVJetTags:probb", "pfDeepCSVJetTags:probbb"]),
    # reco_btagAlgosDeepJet = cms.VInputTag(["pfDeepFlavourJetTags:probb", "pfDeepFlavourJetTags:probbb", "pfDeepFlavourJetTags:problepb"]),

    # triggerTable             = cms.InputTag('TriggerResults::HLT2'),
    triggerTable             = cms.InputTag("TriggerResults","","HLT2"),
