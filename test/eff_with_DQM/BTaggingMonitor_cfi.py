...
hltBTVmonitoring.btagAlgos = ["pfDeepCSVJetTags:probb", "pfDeepCSVJetTags:probbb"]
hltBTVmonitoring.workingpoint = cms.double(0.) #no cut applied
...
hltBTVmonitoring.bjetSelection = cms.string('pt>30 & abs(eta)<2.5')
