...
process.load('HLTrigger.Configuration.HLT_noCaloRoiPF_cff')
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/mc/Run3Winter21DRMiniAOD/QCD_Pt-120To170_MuEnrichedPt5_TuneCP5_14TeV-pythia8/GEN-SIM-DIGI-RAW/FlatPU30to80FEVT_112X_mcRun3_2021_realistic_v16-v3/270000/0012597c-8497-4d8a-8f01-f555656838a0.root'),
...
process.dropCommands=process.RAWSIMEventContent.clone()
process.dropCommands.outputCommands.extend(process.source.inputCommands[1:])
