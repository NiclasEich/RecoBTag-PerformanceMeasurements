...
BTagMu_AK4DiJet20_Mu5.jetSelection = cms.string('pt>10 & abs(eta)<2.5')
BTagMu_AK4DiJet20_Mu5.bjetSelection = cms.string('pt>5 & abs(eta)<2.5')
...
BTagMu_AK4DiJet40_Mu5.jetSelection = cms.string('pt>30 & abs(eta)<2.5')
BTagMu_AK4DiJet40_Mu5.bjetSelection = cms.string('pt>20 & abs(eta)<2.5')
...
BTagMu_AK4DiJet70_Mu5.jetSelection = cms.string('pt>50 & abs(eta)<2.5')
...
BTagMu_AK4DiJet110_Mu5.jetSelection = cms.string('pt>90 & abs(eta)<2.5')
...
BTagMu_AK4DiJet170_Mu5.jetSelection = cms.string('pt>150 & abs(eta)<2.5')
...
BTagMu_AK4Jet300_Mu5.jetSelection = cms.string('pt>250 & abs(eta)<2.5')
...
BTagMu_AK8DiJet170_Mu5.jetSelection = cms.string('pt>150 & abs(eta)<2.5')
...
BTagMu_AK8Jet300_Mu5.jetSelection = cms.string('pt>250 & abs(eta)<2.5')
...
BTagMu_AK8Jet170_DoubleMu5.jetSelection = cms.string('pt>150 & abs(eta)<2.5')
...
PFJet40.jetSelection = cms.string('pt>30 & abs(eta)<2.5')
PFJet40.bjetSelection = cms.string('pt>20 & abs(eta)<2.5')
...
PFJet60.jetSelection = cms.string('pt>50 & abs(eta)<2.5')
...
PFJet80.jetSelection = cms.string('pt>70 & abs(eta)<2.5')
...
PFJet140.jetSelection = cms.string('pt>120 & abs(eta)<2.5')
...
PFJet200.jetSelection = cms.string('pt>170 & abs(eta)<2.5')
...
PFJet260.jetSelection = cms.string('pt>220 & abs(eta)<2.5')
...
PFJet320.jetSelection = cms.string('pt>280 & abs(eta)<2.5')
...
PFJet400.jetSelection = cms.string('pt>350 & abs(eta)<2.5')
...
PFJet450.jetSelection = cms.string('pt>400 & abs(eta)<2.5')
...
PFJet500.jetSelection = cms.string('pt>450 & abs(eta)<2.5')
...
PFJet550.jetSelection = cms.string('pt>500 & abs(eta)<2.5')
...
AK8PFJet40.jetSelection = cms.string('pt>30 & abs(eta)<2.5')
AK8PFJet40.bjetSelection = cms.string('pt>20 & abs(eta)<2.5')
...
AK8PFJet60.jetSelection = cms.string('pt>50 & abs(eta)<2.5')
...
AK8PFJet80.jetSelection = cms.string('pt>70 & abs(eta)<2.5')
...
AK8PFJet140.jetSelection = cms.string('pt>120 & abs(eta)<2.5')
...
AK8PFJet200.jetSelection = cms.string('pt>170 & abs(eta)<2.5')
...
AK8PFJet260.jetSelection = cms.string('pt>220 & abs(eta)<2.5')
...
AK8PFJet320.jetSelection = cms.string('pt>280 & abs(eta)<2.5')
...
AK8PFJet400.jetSelection = cms.string('pt>350 & abs(eta)<2.5')
...
AK8PFJet450.jetSelection = cms.string('pt>400 & abs(eta)<2.5')
...
AK8PFJet500.jetSelection = cms.string('pt>450 & abs(eta)<2.5')
...
AK8PFJet550.jetSelection = cms.string('pt>500 & abs(eta)<2.5')
...
PFJetFwd40.bjetSelection = cms.string('pt>20 & abs(eta)<2.5')
